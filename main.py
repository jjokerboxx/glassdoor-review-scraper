...
Cons text
Advice to mgmttext
Ratings for each of 6 categories
Overall rating
'''
...
def scrape(field, review, author):
    ...
    def scrape_years(review):
        res = review.find_element_by_class_name('gdReview').find_element_by_xpath("//div[@class='d-flex justify-content-between']/div[@class='d-flex align-items-center']/time").text
        return res
    ...
    def scrape_pros(review):
        try:
            pros = review.find_element_by_class_name('v2__EIReviewDetailsV2__lineHeightLarge')
    ...
    def scrape_cons(review):
        try:
            cons = review.find_elements_by_class_name('v2__EIReviewDetailsV2__lineHeightLarge')[1]
    ...
    def scrape_advice(review):
        try:
            advice = review.find_elements_by_class_name('v2__EIReviewDetailsV2__lineHeightLarge')[2]
...
def extract_from_page():
    ...
    def is_featured(review):
        try:
            ...
            # review.find_element_by_class_name('authorInfo')
            return True
        except selenium.common.exceptions.NoSuchElementException:
            return False

    # checking there is any deleted reviews
